...
type MsgSetPaymentContractAuthorisation struct {
	...
	PayerDid          github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=payer_did,json=payerDid,proto3,casttype=github.com/xcohub/xco-blockchain/x/iid/types.DIDFragment" json:"payer_did,omitempty" yaml:"payer_did"`
...
type MsgCreatePaymentTemplate struct {
	CreatorDid      github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=creator_did,json=creatorDid,proto3,casttype=github.com/xcohub/xco-blockchain/x/iid/types.DIDFragment" json:"creator_did,omitempty" yaml:"creator_did"`
