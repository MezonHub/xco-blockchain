...
ldflags = \
    ...
    -X "github.com/xcohub/xco-blockchain/version.BuildTags=$(build_tags_comma_sep)" \
...
draw-deps:
	...
	@goviz -i github.com/xcohub/xco-blockchain/cmd/xcod -d 2 | dot -Tpng -o dependency-graph.png
