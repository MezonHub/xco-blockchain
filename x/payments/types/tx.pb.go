...
type MsgSetPaymentContractAuthorisation struct {
	...
	PayerDid          github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=payer_did,json=payerDid,proto3,casttype=github.com/furylockerroom/xco-blockchain/x/iid/types.DIDFragment" json:"payer_did,omitempty" yaml:"payer_did"`
...
func (m *MsgSetPaymentContractAuthorisation) GetPayerDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.PayerDid
	}
	return ""
...
type MsgCreatePaymentTemplate struct {
	CreatorDid      github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=creator_did,json=creatorDid,proto3,casttype=github.com/furylockerroom/xco-blockchain/x/iid/types.DIDFragment" json:"creator_did,omitempty" yaml:"creator_did"`
...
func (m *MsgCreatePaymentTemplate) GetCreatorDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.CreatorDid
	}
	return ""
...
func (m *MsgCreatePaymentContract) GetCreatorDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.CreatorDid
	}
	return ""
...
func (m *MsgGrantDiscount) GetSenderDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *MsgRevokeDiscount) GetSenderDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *MsgEffectPayment) GetSenderDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *MsgSetPaymentContractAuthorisation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.PayerDid = github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
