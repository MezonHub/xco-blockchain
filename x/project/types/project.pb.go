...
type CreateAgentDoc struct {
	AgentDid github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=agent_did,json=agentDid,proto3,casttype=github.com/furylockerroom/xco-blockchain/x/iid/types.DIDFragment" json:"did" yaml:"did"`
...
func (m *CreateAgentDoc) GetAgentDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.AgentDid
	}
	return ""
...
type WithdrawFundsDoc struct {
	...
	RecipientDid github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=recipient_did,json=recipientDid,proto3,casttype=github.com/furylockerroom/xco-blockchain/x/iid/types.DIDFragment" json:"recipientDid" yaml:"recipientDid"`
...
func (m *WithdrawFundsDoc) GetRecipientDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
...
type ProjectDoc struct {
	...
	SenderDid  github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,3,opt,name=sender_did,json=senderDid,proto3,casttype=github.com/furylockerroom/xco-blockchain/x/iid/types.DIDFragment" json:"senderDid" yaml:"senderDid"`
...
func (m *ProjectDoc) GetSenderDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *WithdrawalInfoDoc) GetRecipientDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.RecipientDid
	}
	return ""
...
type Claim struct {
	...
	ClaimerDid github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,3,opt,name=claimer_did,json=claimerDid,proto3,casttype=github.com/furylockerroom/xco-blockchain/x/iid/types.DIDFragment" json:"claimer_did,omitempty" yaml:"claimer_did"`
...
func (m *Claim) GetClaimerDid() github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.ClaimerDid
	}
	return ""
...
func (m *CreateAgentDoc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AgentDid = github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *Claim) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.ClaimerDid = github_com_furylockerroom_xco_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Status", wireType)
