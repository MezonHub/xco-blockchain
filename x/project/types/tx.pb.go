...
type MsgCreateProject struct {
	...
	SenderDid      github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=sender_did,json=senderDid,proto3,casttype=github.com/xcohub/xco-blockchain/x/iid/types.DIDFragment" json:"senderDid" yaml:"senderDid"`
...
type MsgWithdrawFunds struct {
	SenderDid     github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=sender_did,json=senderDid,proto3,casttype=github.com/xcohub/xco-blockchain/x/iid/types.DIDFragment" json:"senderDid" yaml:"senderDid"`
