...
type MsgSetupMinter struct {
	MinterDid     github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=minterDid,proto3,casttype=github.com/xcohub/xco-blockchain/x/iid/types.DIDFragment" json:"minter_did" yaml:"minter_did"`
...
type MsgMint struct {
	...
	OwnerDid        github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=ownerDid,proto3,casttype=github.com/xcohub/xco-blockchain/x/iid/types.DIDFragment" json:"minter_did" yaml:"minter_did"`
