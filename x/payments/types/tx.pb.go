...
func (m *MsgSetPaymentContractAuthorisation) GetPayerDid() github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.PayerDid
	}
	return ""
...
func (m *MsgCreatePaymentTemplate) GetCreatorDid() github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.CreatorDid
	}
	return ""
...
func (m *MsgCreatePaymentContract) GetCreatorDid() github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.CreatorDid
	}
	return ""
...
func (m *MsgGrantDiscount) GetSenderDid() github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *MsgRevokeDiscount) GetSenderDid() github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *MsgEffectPayment) GetSenderDid() github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *MsgSetPaymentContractAuthorisation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.PayerDid = github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
